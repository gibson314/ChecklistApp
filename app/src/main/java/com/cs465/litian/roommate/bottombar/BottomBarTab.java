package com.cs465.litian.roommate.bottombar;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tabnotselected));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.tabnotselected));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.tabselected));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.tabselected));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.tabnotselected));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.tabnotselected));
        }
    }
